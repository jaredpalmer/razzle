...
```bash
node -e 'require("./test/fixtures/util").setupStageWithExample("with-experimental-refresh", "with-experimental-refresh", symlink=false, yarnlink=true, install=true, test=false);'
