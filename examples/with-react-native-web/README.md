...
```bash
node -e 'require("./test/fixtures/util").setupStageWithExample("with-react-native-web", "with-react-native-web", symlink=false, yarnlink=true, install=true, test=false);'
