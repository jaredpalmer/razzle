...
```bash
node -e 'require("./test/fixtures/util").setupStageWithExample("with-custom-environment-variables", "with-custom-environment-variables", symlink=false, yarnlink=true, install=true, test=false);'
