...
```bash
node -e 'require("./test/fixtures/util").setupStageWithExample("with-typescript-plugin", "with-typescript-plugin", symlink=false, yarnlink=true, install=true, test=false);'
