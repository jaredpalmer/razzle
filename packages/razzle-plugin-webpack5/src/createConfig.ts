...
export default async (
  ...
  const buildConfig = razzleContext.buildMatrix[devMatrixName];
  ...
  for (const buildTarget of allTargets) {
    ...
    let webpackConfig: Configuration = {
      ...
      entry: isServer ?
        (webpackOptions.isDevEnv ? razzleContext.paths.appServerIndex : razzleContext.paths.appServerPath) :
        razzleContext.paths.appClientPath,

      // Path and filename of your result bundle.
      // Webpack will bundle all JavaScript into this file
      output: {
        path: isServer ? razzleContext.paths.appBuild : razzleContext.paths.appBuildPublic,
        publicPath: "",
