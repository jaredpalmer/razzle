...
* Escape hatches for customization via `.babelrc`, `.eslintrc`, `postcss.config.js`, and `razzle.config.js`
...
* [Customization](#customization)
  ...
  * [Custom PostCSS Config](#custom-postcss-config)
...
Razzle comes with [PostCSS defaults](packages/razzle/config/createConfig.js#L69). Add a `postcss.config.js` file to the root of your project to use your own configuration.
